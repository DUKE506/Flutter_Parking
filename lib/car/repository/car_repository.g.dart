...
class _CarRepository implements CarRepository {
  _CarRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ListModel<CarParkingModel>> getCarByType({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ListModel<CarParkingModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${type.name}',
    ...
    late ListModel<CarParkingModel> _value;
    try {
  ...
  Future<CarDetailModel> getDetailById({required String id}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CarDetailModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/detail/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CarDetailModel _value;
    try {
      _value = CarDetailModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> addVisitCar({required CarAddVisitModel model}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<void> addResidentCar({required CarAddResidentModel model}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
...
String _$carRepositoryHash() => r'32e9f3371344afb51a296000126c6d5263706745';
