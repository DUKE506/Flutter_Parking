...
class CarResidentAddScreen extends StatefulWidget {
  const CarResidentAddScreen({super.key});

  @override
  State<CarResidentAddScreen> createState() => _CarResidentAddScreenState();
}

class _CarResidentAddScreenState extends State<CarResidentAddScreen> {
  //Form 모델
